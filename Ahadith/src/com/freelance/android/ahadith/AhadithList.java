...
@SuppressLint("NewApi")
public class AhadithList extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		BugSenseHandler.initAndStartSession(AhadithList.this, "bfdfcbf3");
		...
		btnHome.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(AhadithList.this, MainActivity.class);
		...
		btnMax.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				float a = tv.getTextSize();
				
				if(hadithFontSize<26){
					hadithFontSize +=  2;
					}
					else{
					Toast.makeText(getApplicationContext(), "هذا اقصى حجم للخط", Toast.LENGTH_SHORT).show();
					}
				System.out.println(	hadithFontSize + "");
		...
		btnMin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				TextView tv = (TextView)findViewById(R.id.hadith_deg);
				float a = tv.getTextSize();
				System.out.println(	tv.getTextSize() + " min");
				if(hadithFontSize>14){
				hadithFontSize -=  2;
				}
				else{
				Toast.makeText(getApplicationContext(), "هذا ادنى حجم للخط", Toast.LENGTH_SHORT).show();
				}
				//	hadithFontSize -= 2;
					fonting = hadithFontSize;
...
try{
	...
	public ArrayList<String> getSomeAhadith(ArrayList<Integer> listofids) {
		...
		setListAdapter(new AhadithListAdapter(AhadithList.this, gethadList()));
	...
	public ArrayList<String> getAllAhadith() {
		try {
			db1 = openOrCreateDatabase(DBNAME, Context.MODE_PRIVATE, null);
			Cursor cursor = db1.rawQuery("SELECT * FROM  " + TABLE + " order by HadithID Asc", null);
			if (cursor != null) {
				if (cursor.moveToFirst() && cursor.getCount() > 0) {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			Intent intent = null;
			if (fromSearch) {
				intent = new Intent(AhadithList.this, SearchActivity.class);
			} else {
				intent = new Intent(AhadithList.this, MainActivity.class);
			}
