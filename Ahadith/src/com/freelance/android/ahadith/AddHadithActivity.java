...
public class AddHadithActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        BugSenseHandler.initAndStartSession(AddHadithActivity.this, "bfdfcbf3");

		setContentView(R.layout.add_hadith_new);

		adImage = (ImageView) findViewById(R.id.adimage);
		wvAddHadith = (WebView) findViewById(R.id.wv_add_hadith);
		wvAddHadith.loadUrl("http://dorar.net/feedback/hadith?h4app=1");
		...
		homebtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent homeintent = new Intent(AddHadithActivity.this,
						MainActivity.class);
...
//
//
//        BugSenseHandler.flush(AddHadithActivity.this);
//
//    }
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			// your code
			Intent intent = new Intent(AddHadithActivity.this,
					MainActivity.class);
